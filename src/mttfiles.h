...
void  on_open_clicked (GtkButton  *button,  APP_data *data_app);
gboolean   on_quit_clicked  (GtkWidget *window1, GdkEvent  *event, APP_data *data_app);
...
void on_AudioCloseFile_clicked  (GtkButton *button, APP_data *data);
void  on_loadPDF_clicked       (GtkButton  *button, APP_data *data);
void quick_load_PDF (gchar *filename, APP_data *data);
void  on_savePDF_clicked       (GtkButton  *button, APP_data *data);
void on_saveSketch_clicked        (GtkButton  *button, APP_data *data_app);
void on_help_clicked                 (GtkWidget        *win);
